  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (final DetectedObject detectedObject in _objects) {
      ...
      if (matchingLabel != null) {
        ...
        final textToSpeech = '$matchingLabel ${calculatePosition(centerX, size.width)}\n';
        if (textToSpeech != lastSpokenWord) {
          wordQueue.add(textToSpeech);
          lastSpokenWord = textToSpeech;
        }
        builder.pop();
